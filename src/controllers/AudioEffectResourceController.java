 ...
 * @author winniewang
 */
public class AudioEffectResourceController {
    ...
    private static AudioEffectResourceController arc;
    
    
    private AudioEffectResourceController(){
        sounds = new HashMap<>();
    }
    
    public static AudioEffectResourceController getInstance(){
        if(arc == null){
            arc = new AudioEffectResourceController();
        }
        return arc;
    }
